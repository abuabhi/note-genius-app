...
-- This will clear all data and reset to onboarding state
...
DELETE FROM public.simple_flashcard_progress WHERE user_id = '1bf8c758-f0ee-4b69-9eb7-c87aa99651ef';
...
DELETE FROM public.study_session_activities WHERE session_id IN (SELECT id FROM public.study_sessions WHERE user_id = '1bf8c758-f0ee-4b69-9eb7-c87aa99651ef');
...
DELETE FROM public.quiz_card_responses WHERE user_id = '1bf8c758-f0ee-4b69-9eb7-c87aa99651ef';
DELETE FROM public.quiz_sessions WHERE user_id = '1bf8c758-f0ee-4b69-9eb7-c87aa99651ef';
DELETE FROM public.quiz_performance_history WHERE user_id = '1bf8c758-f0ee-4b69-9eb7-c87aa99651ef';
...
SET 
  ...
  notification_preferences = '{"email": true, "push": true, "in_app": true}'::jsonb,
  updated_at = now()
