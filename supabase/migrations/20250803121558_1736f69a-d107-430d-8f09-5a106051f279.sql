...
-- Clean up the stuck session for the current user with reasonable duration cap (4 hours max)
UPDATE public.study_sessions 
SET 
  is_active = false,
  end_time = start_time + INTERVAL '4 hours',
  duration = 14400, -- 4 hours in seconds
  notes = COALESCE(notes, '') || ' (Auto-closed due to technical issue - capped at 4 hours)'
