-- Populate comprehensive help content for all categories (Fixed escaping)
...
('Password Security', 'Manage password changes, two-factor authentication, and account security', 'settings', 7, '["password", "security", "2FA", "authentication", "account-safety"]'::jsonb, '["Use strong, unique passwords", "Enable two-factor authentication", "Change passwords regularly", "Do not share login credentials", "Review login activity for suspicious access"]'::jsonb, true, false);
