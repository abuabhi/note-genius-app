...
export const StudyAchievements = () => {
  const { achievementProgress, loading } = useAchievementProgress();
  ...
  const renderAchievementCard = (achievement: any) => (
    <Card key={achievement.id} className={`border-2 transition-all hover:shadow-md ${
  ...
  const renderAchievementSection = (title: string, achievements: any[], description: string) => {
  ...
  return (
    <div className="space-y-8">
      ...
      {renderAchievementSection(
        "Study Consistency",
        studyMilestones,
        "Achievements for maintaining regular study habits and building streaks"
      )}

      {renderAchievementSection(
        "Content Mastery",
        masteryAchievements,
        "Achievements for mastering flashcards and reaching learning milestones"
      )}

      {renderAchievementSection(
        "Content Creation",
        contentCreation,
        "Achievements for creating and organizing study materials"
      )}
