  ...
  (
    ...
    return (
      <div
        ...
        className={cn(
          "pointer-events-none absolute left-full z-20 ml-2 opacity-0 transition-opacity group-hover/menu-item:pointer-events-auto group-hover/menu-item:opacity-100 group-data-[collapsible=icon]:opacity-100",
          state === "collapsed" && !isMobile && "group-hover/menu-item:opacity-100"
        )}
        {...tooltip}
      >
        {button}
