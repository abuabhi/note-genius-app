  ...
  return (
    <div className="space-y-8">
      <ComingSoonBanner
        ...
        description="Comprehensive performance metrics, detailed analytics dashboards, and predictive insights are being developed to help you track your learning progress in depth."
        size="large"
      />
