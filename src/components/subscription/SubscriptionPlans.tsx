...
const plans: Plan[] = [
  {
    ...
    features: [
      ...
      { text: 'AI Enrichment limits', included: true },
      { text: 'Number of Quizz', included: true },
      { text: 'AI Chat', included: true },
      { text: 'Import as PDF', included: true },
      { text: 'Import from YouTube URL', included: true },
      { text: 'Import from OneNote', included: true },
      { text: 'Import from Google Docs', included: true },
      { text: 'Inline expansion', included: true },
      { text: 'Study Plan', included: true },
      { text: 'Goals', included: true },
      { text: 'ToDO', included: true },
    ],
  },
  {
    id: 'MASTER',
    ...
    features: [
      ...
      { text: 'AI Enrichment Limits', included: true },
      { text: 'Number of Quiz', included: true },
      { text: 'AI Chat', included: true },
      { text: 'Import as PDF', included: true },
      { text: 'Import from YouTube URL', included: true },
      { text: 'Import from OneNote', included: true },
      { text: 'Import from Google Docs', included: true },
      { text: 'Handwritten notes', included: true },
      { text: 'Inline expansion', included: true },
      { text: 'Study Plan', included: true },
      { text: 'Goals', included: true },
      { text: 'ToDO', included: true },
