...
export const NotificationPopover = () => {
  ...
  console.log('🔔 NotificationPopover - UNIFIED SYSTEM ONLY - Unread:', unreadCount);
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button 
          variant="ghost" 
          size="icon" 
          className="relative h-9 w-9 rounded-full hover:bg-green-50 text-green-600 hover:text-green-700 flex-shrink-0"
        >
        ...
        <div className="flex justify-between items-center p-4 border-b">
          <div className="flex items-center gap-2">
            ...
            {unreadCount > 0 && (
              <Badge 
                variant="outline" 
                className={hasOverdueReminders ? 'text-red-600 border-red-300' : 'text-green-600 border-green-300'}
              >
                {unreadCount} active
              </Badge>
            )}
